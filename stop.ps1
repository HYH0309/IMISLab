      ...
      if ($processes) {
        ...
        foreach ($process in $processes) {
            try {
                ...
                Write-Host "   Could not stop $processName (PID: $($process.Id))" -ForegroundColor Yellow
            }
        }
    } else {
